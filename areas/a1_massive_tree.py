a1_massive_tree = {
    ...
    "intro": [
        {
            "speaker": "narrator",
            "text": (
                "You stand in a clearing beside a <em><span class='area-highlight'>Massive Tree</span></em>, its thick trunk and branches spreading "
    ...
    "description": (
        "You stand in a clearing beside a <em><span class='area-highlight'>Massive Tree</span></em>  "
        "There's no direction to go except back the way you came."
    ),
    "items": [],
    "scenery": {
