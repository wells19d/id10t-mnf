...
from areas.a1_security_gate import a1_guard_station, a1_security_gate
from areas.a1_silent_grove import a1_silent_grove
from areas.a1_stone_ring import a1_stone_ring
from areas.a2_entry import a2_entry

area1Locations = [
    ("a1_clearing", a1_clearing),
    ("a1_fallen_nursery", a1_fallen_nursery),
    ("a1_house_1", a1_house_1),
    ("a1_house_1_living_room", a1_house_1_living_room),
    ("a1_house_1_kitchen", a1_house_1_kitchen),
    ("a1_house_1_bathroom", a1_house_1_bathroom),
    ("a1_house_1_bedroom_1", a1_house_1_bedroom_1),
    ("a1_house_1_bedroom_2", a1_house_1_bedroom_2),
    ("a1_house_2", a1_house_2),
    ("a1_house_2_living_room", a1_house_2_living_room),
    ("a1_house_2_kitchen", a1_house_2_kitchen),
    ("a1_house_2_bathroom", a1_house_2_bathroom),
    ("a1_house_2_bedroom", a1_house_2_bedroom),
    ("a1_house_3", a1_house_3),
    ("a1_house_3_living_room", a1_house_3_living_room),
    ("a1_house_3_kitchen", a1_house_3_kitchen),
    ("a1_house_3_bathroom", a1_house_3_bathroom),
    ("a1_house_3_bedroom_1", a1_house_3_bedroom_1),
    ("a1_house_3_bedroom_2", a1_house_3_bedroom_2),
    ...
    ("a1_guard_station", a1_guard_station),
